...
# 결국 현재 1 하나만으로 이루어진 타일 또는 0타일을 두 개 붙인 한 쌍의 00타일들만이 
# 남게 되었다.
...
# N=5, 00001, 00100, 10000, 11100, 00111, 11111 = 6
# N=6, 000000, 000011, 001001, 001100, 100001, 100100, 110000, 001111, 110011, 111100, 111111 =11
# 2로 나눈 정수 몫만큼 00 타일을 가질 수 있다.
